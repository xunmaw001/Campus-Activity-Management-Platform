<template>
  <div class="main-content">
      ...
      <div class="table-content">
        <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
            ...
            <el-table-column width="300" :align="contents.tableAlign"
                ...
                <el-button v-if="isAuth('huodongxinxi','生成名单') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="huodongcanyurenyuanCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'生成名单':'' }}</el-button>
                <el-button v-if="isAuth('huodongxinxi','生成名单') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="huodongcanyurenyuanCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'生成名单':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('huodongxinxi','生成名单') && contents.tableBtnIcon == 0" type="success" size="mini" @click="huodongcanyurenyuanCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'生成名单':'' }}</el-button>
                <el-button v-if="isAuth('huodongxinxi','生成经费列表') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 1" type="success" icon="el-icon-tickets" size="mini" @click="huodongjingfeiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'生成经费列表':'' }}</el-button>
                <el-button v-if="isAuth('huodongxinxi','生成经费列表') && contents.tableBtnIcon == 1 && contents.tableBtnIconPosition == 2" type="success" size="mini" @click="huodongjingfeiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'生成经费列表':'' }}<i class="el-icon-tickets el-icon--right" /></el-button>
                <el-button v-if="isAuth('huodongxinxi','生成经费列表') && contents.tableBtnIcon == 0" type="success" size="mini" @click="huodongjingfeiCrossAddOrUpdateHandler(scope.row,'cross')">{{ contents.tableBtnFont == 1?'生成经费列表':'' }}</el-button>
    ...
    <huodongcanyurenyuan-cross-add-or-update v-if="huodongcanyurenyuanCrossAddOrUpdateFlag" :parent="this" ref="huodongcanyurenyuanCrossaddOrUpdate"></huodongcanyurenyuan-cross-add-or-update>
    <huodongjingfei-cross-add-or-update v-if="huodongjingfeiCrossAddOrUpdateFlag" :parent="this" ref="huodongjingfeiCrossaddOrUpdate"></huodongjingfei-cross-add-or-update>
...
import huodongcanyurenyuanCrossAddOrUpdate from "../huodongcanyurenyuan/add-or-update";
import huodongjingfeiCrossAddOrUpdate from "../huodongjingfei/add-or-update";
...
export default {
  data() {
    return {
      ...
      huodongcanyurenyuanCrossAddOrUpdateFlag: false,
      huodongjingfeiCrossAddOrUpdateFlag: false,
  ...
  components: {
    AddOrUpdate,
    huodongcanyurenyuanCrossAddOrUpdate,
    huodongjingfeiCrossAddOrUpdate,
  ...
  methods: {
    ...
    huodongcanyurenyuanCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.huodongcanyurenyuanCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','huodongxinxi');
      this.$nextTick(() => {
      this.$refs.huodongcanyurenyuanCrossaddOrUpdate.init(row.id,type);
      });
    },
    huodongjingfeiCrossAddOrUpdateHandler(row,type){
      this.showFlag = false;
      this.addOrUpdateFlag = false;
      this.huodongjingfeiCrossAddOrUpdateFlag = true;
      this.$storage.set('crossObj',row);
      this.$storage.set('crossTable','huodongxinxi');
      this.$nextTick(() => {
      this.$refs.huodongjingfeiCrossaddOrUpdate.init(row.id,type);
      });
    },
