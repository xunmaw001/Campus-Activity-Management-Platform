<template>
  <div class="addEdit-block">
    ...
    >
      <el-row>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="撰写人" prop="zhuanxieren">
          <el-input v-model="ruleForm.zhuanxieren" 
              placeholder="撰写人" clearable  :readonly="ro.zhuanxieren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="撰写人" prop="zhuanxieren">
              <el-input v-model="ruleForm.zhuanxieren" 
                placeholder="撰写人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="提交部门" prop="tijiaobumen">
          <el-input v-model="ruleForm.tijiaobumen" 
              placeholder="提交部门" clearable  :readonly="ro.tijiaobumen"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="提交部门" prop="tijiaobumen">
              <el-input v-model="ruleForm.tijiaobumen" 
                placeholder="提交部门" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="文稿内容" prop="wengaoneirong">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.wengaoneirong" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.wengaoneirong" label="文稿内容" prop="wengaoneirong">
                    <span v-html="ruleForm.wengaoneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
        ...
        for (var o in obj){
          if(o=='zhuanxieren'){
            this.ruleForm.zhuanxieren = obj[o];
	    this.ro.zhuanxieren = true;
            continue;
          }
          if(o=='tijiaobumen'){
            this.ruleForm.tijiaobumen = obj[o];
	    this.ro.tijiaobumen = true;
            continue;
          }
          if(o=='tijiaoshijian'){
	    ...
	    this.ro.tijiaoshijian = true;
          ...
          if(o=='wengaoneirong'){
            this.ruleForm.wengaoneirong = obj[o];
	    this.ro.wengaoneirong = true;
            continue;
          }
        }
      }
	...
	this.ruleForm.wengaoneirong = this.ruleForm.wengaoneirong.replace(reg,'../../../ssml1ro4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `xinwengao/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.xinwengaoCrossAddOrUpdateFlag = false;
                  this.parent.search();
