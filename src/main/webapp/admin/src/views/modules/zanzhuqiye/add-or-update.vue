<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="相关负责人" prop="xiangguanfuzeren">
          <el-input v-model="ruleForm.xiangguanfuzeren" 
              placeholder="相关负责人" clearable  :readonly="ro.xiangguanfuzeren"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="相关负责人" prop="xiangguanfuzeren">
              <el-input v-model="ruleForm.xiangguanfuzeren" 
                placeholder="相关负责人" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="24">  
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="企业信息" prop="qiyexinxi">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.qiyexinxi" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.qiyexinxi" label="企业信息" prop="qiyexinxi">
                    <span v-html="ruleForm.qiyexinxi"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.qiyemingcheng = true;
          ...
          if(o=='qiyexinxi'){
            this.ruleForm.qiyexinxi = obj[o];
	    this.ro.qiyexinxi = true;
            continue;
          }
          if(o=='qiyedizhi'){
	    ...
	    this.ro.qiyeyouxiang = true;
          ...
          if(o=='xiangguanfuzeren'){
            this.ruleForm.xiangguanfuzeren = obj[o];
	    this.ro.xiangguanfuzeren = true;
            continue;
          }
          if(o=='lianxifangshi'){
	...
	this.ruleForm.qiyexinxi = this.ruleForm.qiyexinxi.replace(reg,'../../../ssml1ro4/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `zanzhuqiye/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.zanzhuqiyeCrossAddOrUpdateFlag = false;
                  this.parent.search();
