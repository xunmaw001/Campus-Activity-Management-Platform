<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="赞助企业" prop="zanzhuqiye">
          <el-input v-model="ruleForm.zanzhuqiye" 
              placeholder="赞助企业" clearable  :readonly="ro.zanzhuqiye"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="赞助企业" prop="zanzhuqiye">
              <el-input v-model="ruleForm.zanzhuqiye" 
                placeholder="赞助企业" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="活动内容" prop="huodongneirong">
          <el-input v-model="ruleForm.huodongneirong" 
              placeholder="活动内容" clearable  :readonly="ro.huodongneirong"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动内容" prop="huodongneirong">
              <el-input v-model="ruleForm.huodongneirong" 
                placeholder="活动内容" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="活动开始时间" prop="huodongkaishishijian">
          <el-input v-model="ruleForm.huodongkaishishijian" 
              placeholder="活动开始时间" clearable  :readonly="ro.huodongkaishishijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动开始时间" prop="huodongkaishishijian">
              <el-input v-model="ruleForm.huodongkaishishijian" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="活动结束时间" prop="huodongjieshushijian">
          <el-input v-model="ruleForm.huodongjieshushijian" 
              placeholder="活动结束时间" clearable  :readonly="ro.huodongjieshushijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动结束时间" prop="huodongjieshushijian">
              <el-input v-model="ruleForm.huodongjieshushijian" 
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="活动经费" prop="huodongjingfei">
          <el-input v-model="ruleForm.huodongjingfei" 
              placeholder="活动经费" clearable  :readonly="ro.huodongjingfei"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="活动经费" prop="huodongjingfei">
              <el-input v-model="ruleForm.huodongjingfei" 
                placeholder="活动经费" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fabushijian = true;
          ...
          if(o=='zanzhuqiye'){
            this.ruleForm.zanzhuqiye = obj[o];
	    this.ro.zanzhuqiye = true;
            continue;
          }
          if(o=='huodongneirong'){
	    ...
	    this.ro.huodongchangdi = true;
          ...
          if(o=='huodongjingfei'){
            this.ruleForm.huodongjingfei = obj[o];
	    this.ro.huodongjingfei = true;
            continue;
          }
        }
      }
    ...
    onSubmit() {
      ...
      this.$refs["ruleForm"].validate(valid => {
        if (valid) {
          this.$http({
            url: `huodongjingfei/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.huodongjingfeiCrossAddOrUpdateFlag = false;
                  this.parent.search();
