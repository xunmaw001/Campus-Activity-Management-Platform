<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="场地编号" prop="changdibianhao">
          <el-input v-model="ruleForm.changdibianhao" 
              placeholder="场地编号" clearable  :readonly="ro.changdibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="场地编号" prop="changdibianhao">
              <el-input v-model="ruleForm.changdibianhao" 
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="是否空闲" prop="shifoukongxian">
          <el-select v-model="ruleForm.shifoukongxian" placeholder="请选择是否空闲">
            <el-option
                v-for="(item,index) in shifoukongxianOptions"
                v-bind:key="index"
                :label="item"
                :value="item">
            </el-option>
        ...
        <div v-else>
          <el-form-item class="input" label="是否空闲" prop="shifoukongxian">
	      <el-input v-model="ruleForm.shifoukongxian"
                placeholder="是否空闲" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="24">  
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.changdiweizhi = true;
          ...
          if(o=='shifoukongxian'){
            this.ruleForm.shifoukongxian = obj[o];
	    this.ro.shifoukongxian = true;
            continue;
          }
          if(o=='tupian'){
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          ...
          this.$message.error(data.msg);
            ...
            this.shifoukongxianOptions = "空闲,不空闲".split(',')
    },
    // 多级联动参数
    info(id) {
      this.$http({
