 ...
 */
@TableName("xinwengao")
public class XinwengaoEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public XinwengaoEntity() {
		
	}
	
	public XinwengaoEntity(T t) {
		try {
	 ...
	 * 设置：撰写人
	 */
	public void setZhuanxieren(String zhuanxieren) {
		this.zhuanxieren = zhuanxieren;
	}
	/**
	 * 获取：撰写人
	 */
